...
def scib(pred:dict, label:list, dim_c:int = 32, subsample:float = 0.5, verbose:bool = True):
...
def scmib(pred:dict, label:list, masks:list, dim_c:int = 32, si_metric:str = "euclidean", verbose:bool = True):
    """ Evaluation the results for MIDAS, including modality ASW, FOSCTTM, label transfer F1, ATAC AUROC, RNA Pearson’s r, and ADT Pearson’s r.
