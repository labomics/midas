...
atac <- read.csv(paste0(temp_dir, 'atac.csv'), header=TRUE, row.names=1)
...
print("R script: Running ATAC processing...")
...
obj <- FindMultiModalNeighbors(obj, list("lsi", "pca_rna", "pca_adt"), list(1:32, 1:32, 1:32))
